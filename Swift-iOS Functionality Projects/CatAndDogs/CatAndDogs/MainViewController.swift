...
//  CatAndDogs
//
//  Created by Kaloyan Petrov on 11/23/15.
...
class MainViewController: UIViewController,AVAudioPlayerDelegate {
    ...
    @IBOutlet weak var randomFactoidTextView: UILabel!
    //Audio Player
    ...
    @IBAction func calculateCatYears(sender: AnyObject) {
        ...
        case 2:
            ...
            catAgeResult.text = String(result)
        default:
            let intermResult = (age - 2) * 4
            result = intermResult + 24
            catAgeResult.text = String(result)
        }
        //Play sound
        do {
    ...
    @IBAction func calculateRandomFactoid(sender: AnyObject) {
        
        let randomNumber = Int(arc4random_uniform(UInt32(factoids.count)))
        randomFactoidTextView.text = factoids[randomNumber]
    }
